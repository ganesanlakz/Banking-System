         ...
         echo "</script>";
                ...
                if($query){
                     echo "<script> alert('Transaction Successful');
                                     window.location='transummary.php';
                           </script>";
...
<nav class="navbar">
    ...
    font-family:'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;    font-style: oblique;"> Make Transaction</h2>
            <?php
                include 'config.php';
                $sid=$_GET['id'];
        ...
        <br>
            ...
            <button class="btn mt-3 btn-info" name="submit" type="submit" id="myBtn">Transfer</button>
            </div>
        </form>
    </div>
    <footer>
